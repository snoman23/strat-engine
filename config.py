...
# =========================
# ALWAYS-INCLUDE (CORE) LISTS
# =========================
# These are ALWAYS included every run, regardless of rotation offset.
# This fixes “why no SPY/QQQ/SMH etc”.
CORE_ETFS = [
    "SPY", "QQQ", "IWM", "DIA",
    "SMH", "XLK", "XLF", "XLE",
    "XLY", "XLP", "XLU", "XLV", "XLI",
...
# Optional: if you ever want guaranteed mega-caps (uncomment + add)
# CORE_STOCKS = ["AAPL", "MSFT", "NVDA", "AMZN", "META", "TSLA", "GOOGL"]
...
# For prod, keep within Yahoo’s intraday limitations.
YF_BASE_FEEDS = {
    "1d": {"period": "max"},
    "60m": {"period": "730d"},
}
